...
public:
	...
	Table Update(std::string table_name, std::vector<std::string> old_attributes, std::vector<std::string> new_values, std::string attribute_name, Token_Type comparison, std::string value);
